---
name: improve-agent-harness-token-efficiency
description: Use when making an LLM agent harness (system prompt, tools, caching, subagents) cheaper without quality loss; based on Cursor's production learnings
source: https://x.com/ericzakariasson (prompt by Eric Zakariasson, Cursor) — mirror https://telegra.ph/EHkonomim-tokeny-09-25
---
