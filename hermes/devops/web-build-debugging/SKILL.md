---
name: web-build-debugging
description: "Debug Vite, Docker, terminal build failures."
---

# Web Build & Deployment Debugging

Debug common web build, Vite, and deployment failures — HMR breaks, Docker white screens, terminal tool rejections.
